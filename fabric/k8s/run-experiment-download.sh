...
#========================================================================================
gcloud container clusters create fieldofgenes --zone $zone --cluster-version 1.8.3-gke.0 --num-nodes $nodes --machine-type $machine --local-ssd-count 2 --image-type ubuntu
